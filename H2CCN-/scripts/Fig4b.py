...
ax.plot((0.28,0.72),(14473,14473),'--',lw='1',color='C0')
...
ax.arrow(0.35,90,0,14500,length_includes_head=True,head_width=0.01,head_length=50,color='C4')
ax2.arrow(0.35,90,0,14500,length_includes_head=True,head_width=0.01,head_length=50,color='C4')
ax.arrow(0.45,90,0,14350,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax2.arrow(0.45,90,0,14350,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax.arrow(0.46,220,0,14350,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax2.arrow(0.46,220,0,14350,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax.arrow(0.60,90,0,14422,length_includes_head=True,head_width=0.01,head_length=50,color='C1')
ax2.arrow(0.60,90,0,14422,length_includes_head=True,head_width=0.01,head_length=50,color='C1')
ax.arrow(0.38,14590,0,-692,length_includes_head=True,head_width=0.01,head_length=50,color='C4')
ax2.arrow(0.38,14590,0,-692,length_includes_head=True,head_width=0.01,head_length=50,color='C4')
ax.arrow(0.49,14473,0,-575,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax2.arrow(0.49,14473,0,-575,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax.arrow(0.50,14590,0,-692,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax2.arrow(0.50,14590,0,-692,length_includes_head=True,head_width=0.01,head_length=50,color='C6')
ax.arrow(0.63,14512,0,-927,length_includes_head=True,head_width=0.01,head_length=50,color='C1')
ax2.arrow(0.63,14512,0,-927,length_includes_head=True,head_width=0.01,head_length=50,color='C1')

#Transition Lines
ax.plot((0.272,0.727),(14590,14590),'--',color='lightseagreen',lw='1')
ax.annotate(r'$3^15^1$',(0.20,14590),color='lightseagreen',fontsize=8)
ax.annotate(r'$5^3$',(0.20,14433),color='C0',fontsize=8)
ax.annotate(r'$4^2$',(0.73,14473),color='C3',fontsize=8)
ax.annotate(r'$4^1$',(0.73,13585),color='C3',fontsize=8)
ax.plot((0.331,0.668),(13585,13585),color='C3',lw='1')
ax.plot((0.28,0.72),(14512,14512),'--',lw='1',color='C3')

#Wavelengths
ax.annotate(r'$\lambda$ = 685 nm',(0.6,12350),fontsize=8,color='C4')
ax.annotate(r'$\lambda$ = 692 nm',(0.6,12200),fontsize=8,color='C6')
ax.annotate(r'$\lambda$ = 691.6 nm',(0.6,12050),fontsize=8,color='C1')
...
plt.xticks([], [])
plt.savefig("Fig4b.pdf",dpi=400,bbbox_inches="tight")
plt.show()
